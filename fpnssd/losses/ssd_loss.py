...
class SSDLoss(nn.Module):
    ...
    def _hard_negative_mining(self, cls_loss, pos):
        ...
        Args:
          cls_loss: (tensor) cross entroy losses between cls_preds and cls_targets, sized [N,#anchors].
    ...
    def forward(self, loc_preds, loc_targets, cls_preds, cls_targets):
        ...
        #===============================================================
        # print(cls_preds.max(), cls_preds.min())
        cls_loss = F.nll_loss(cls_preds, cls_targets, reduce=False) # [N*#anchors,]
        cls_loss = cls_loss.view(batch_size, -1)
        cls_loss[cls_targets<0] = 0  # set ignored losses to 0
